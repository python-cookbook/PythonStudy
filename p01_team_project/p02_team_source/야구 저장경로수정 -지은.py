...
"""
    ...
    def load_record(self, load_path):   # 지은
...
class Game(object):
    ...
    def show_record(self):
        ...
        for i in range(9):
            ...
            self.save_record(save_result_path, *save_hp)   # 지은
            self.save_record(save_result_path, *save_ap)   # 지은
    ...
    def attack(self):
        ...
        self.load_record(save_result_path) # 지은
