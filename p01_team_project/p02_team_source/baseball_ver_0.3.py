...
class Saveandload:
    ...
    def make_data_set(self,PLAYER_INFO,CNT,GAME_INFO,ADV):
        Saveandload.DATA_SET.append([PLAYER_INFO, CNT, GAME_INFO, ADV])




    def save(self):
        with open(Saveandload.FILE_PATH + self.__hometeam.team_name+"VS"+self.__awayteam.team_name+".txt", "at", encoding="utf-8") as f:
