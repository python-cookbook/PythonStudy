    ...
    def load_record(load_path):   # 지은
        try:
            if load_path == None :
                ...
                Game.INNING, curr_team.team_name, player.number, player.name, player.record.avg, player.record.bob, player.record.homerun = record              
    ...
    def attack(self):
        ...
        if Game.OUT_CNT < 3:
            ...
            while True:
                ...
                self.save_record(save_player_path, *save_player)            #지은                
