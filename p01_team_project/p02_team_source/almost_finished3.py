...
### 실시간 선수 기록 저장 ####
save_player_path = "c:\\data\\baseball_save_on1.csv"


### 최종 경기 기록 저장 ###
save_result_path = "c:\\data\\baseball_save_result1.csv"


### 게임을 이어서 할 경우 실시간 경기 기록 불러오기 ### 
#파일이 없으면 None 으로 설정
load_player_path = "c:\\data\\baseball_save_on.csv"


### 기록 분석을 위한 최종 경기 기록 데이터가 필요할 경우 ###
#파일이 없으면 None 으로 설정
load_result_path = "c:\\data\\baseball_save_result.csv"
    ...
    def attack(self):
        ...
        if Game.OUT_CNT < 3:
            ...
            while True:
                ...
                Saveandload.save_record(save_player_path, *save_player)            #지은                
