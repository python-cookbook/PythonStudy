...
class Game(object):
    ...
    def show_record(self):
        ...
        for i in range(9):
            ...
            Saveandload.save_record(save_result_path, *save_hp)   # 지은  #tunning
...
class Main(Game):
    ...
    def state_color(self, CNT1, CNT2, color1, color2="white"):        #지은 #tunning
    ...
    def board(self):
        ...
        self.ball_color = self.state_color(3, self.game.BALL_CNT, "orange")    #지은  #tunning
        self.strike_color = self.state_color(2, self.game.STRIKE_CNT, "blue")
        self.out_color = self.state_color(2, self.game.OUT_CNT, "red")
        ...
        self.canvas.create_oval(430, 315, 460, 345, fill=self.COLOR[self.game.ADVANCE[0]])  # 1루 #tunning
        self.canvas.create_oval(225, 120, 255, 150, fill=self.COLOR[self.game.ADVANCE[1]])  # 2루
        self.canvas.create_oval(20, 315, 50, 345, fill=self.COLOR[self.game.ADVANCE[2]])  # 3루
